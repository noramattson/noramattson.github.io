...
class Fish():
    ...
    def draw(self):
        ...
        pygame.draw.triangle(screen,self.color,self.position_snow,self.size_snow)
    def fall(self, speed):
...
while not done:
   # --- Main event loop
	...
	for i in range(5):
		snow_list.append(SnowFlake(random.randint(2,7),[random.randint(0,700),0],(random.randint(200,255),random.randint(200,255),random.randint(200,255))))
